...
public interface UserApi {
    ...
    default String loginUser(@RequestBody @Valid LoginRequest loginRequest, HttpSession session) {
        return null;
    ...
    default String updateUser(
    		HttpSession session, @Parameter(name = "User", description = "Modifica el usuario en la aplicacion") @Valid @RequestBody(required = true) User user, Model model
    ) {
        return null;
